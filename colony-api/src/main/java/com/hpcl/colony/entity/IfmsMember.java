 ...
 */
@Entity
@Table(name = "COLONY_BVG_MASTER", schema = "orainfo")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class IfmsMember {
    ...
    public String getBvgTeamMemberId() {
        return bvgTeamMemberId;
    }

    public void setBvgTeamMemberId(String bvgTeamMemberId) {
        this.bvgTeamMemberId = bvgTeamMemberId;
    }
