 ...
 */
@Entity
@Table(name = "COLONY_PO_MASTER", schema = "orainfo")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class PoItem {
    ...
    public String getAgtmItem() {
        return agtmItem;
    }

    public void setAgtmItem(String agtmItem) {
        this.agtmItem = agtmItem;
    }
    ...
    public String getAccAssignmentCat() {
        return accAssignmentCat;
    }

    public void setAccAssignmentCat(String accAssignmentCat) {
        this.accAssignmentCat = accAssignmentCat;
    }
